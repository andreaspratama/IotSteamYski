                  ...
                  <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                      <div class="block-options-item">
                        <a href="{{route('indikatoriot.create')}}" class="btn btn-primary">Tambah Indikator</a>
                        {{-- <code>.table</code> --}}
                      </div>
                    </div>
                  </div>
...
@push('addon-script')
    ...
    <script>
      $(document).on('click','.hapus', function () {
          var $indikatornama = $(this).attr('indikatoriot-nama');
          var $indikatorid = $(this).attr('indikatoriot-id');
          swal({
          ...
          .then((willDelete) => {
            ...
            if (willDelete) {
              window.location = "indikatoriot/"+$indikatorid+"/delete";
            } else {
