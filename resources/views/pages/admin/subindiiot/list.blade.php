                  ...
                  <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                      <div class="block-options-item">
                        <a href="{{route('subindiiot.create')}}" class="btn btn-primary">Tambah Sub Indikator</a>
                      </div>
                    </div>
                  </div>
...
@push('addon-script')
    ...
    <script>
        var datatable = $('#tablesubIndikator').DataTable({
            ...
            columns: [
                ...
                { data: 'indikatoriot_id', name: 'indikatoriot_id' },
                { data: 'nama', name: 'nama' },
                {
                    data: 'aksi',
                    name: 'aksi',
    ...
    <script>
      $(document).on('click','.hapus', function () {
          var $subindinama = $(this).attr('subindiiot-nama');
          var $subindiid = $(this).attr('subindiiot-id');
          swal({
          ...
          .then((willDelete) => {
            ...
            if (willDelete) {
              window.location = "subindiiot/"+$subindiid+"/delete";
            } else {
