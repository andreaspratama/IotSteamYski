              ...
              <form action="{{route('guru.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-12 col-xl-12">
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="John Doe" value="{{old('email')}}">
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas" name="kelas" placeholder="John Doe" value="{{old('kelas')}}">
                    ...
                    <div class="mb-4">
                      <input class="form-control @error('ttd') is-invalid @enderror" type="file" id="example-file-input" name="ttd">
                      @error('ttd')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{$message}}
                            </div>
