              ...
              <form action="{{route('guru.update', $item->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="col-lg-12 col-xl-12">
                    ...
                    <div class="form-floating mb-4">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="John Doe" value="{{$item->email}}">
                    ...
                    <img src="{{Storage::url($item->ttd)}}" alt="" class="img-thumbnail mb-2" width="80px">
                  </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
