            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
              <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-2">
                  List Daftar Komp Sub Indikator IoT
                </h1>
                  ...
                  <div class="block-header block-header-default">
                    ...
                    <div class="block-options">
                      <div class="block-options-item">
                        <a href="{{route('nkopeteniot.create')}}" class="btn btn-primary">Tambah Komp Sub Indikator</a>
                      </div>
                    </div>
                  </div>
...
@push('addon-script')
    ...
    <script>
        var datatable = $('#tablesubIndikator').DataTable({
            ...
            columns: [
                ...
                { data: 'subindiiot_id', name: 'subindiiot_id' },
                { data: 'nama', name: 'nama' },
                {
                    data: 'aksi',
                    name: 'aksi',
    ...
    <script>
      $(document).on('click','.hapus', function () {
          var $kompindinama = $(this).attr('kompindiiot-nama');
          var $kompindiid = $(this).attr('kompindiiot-id');
          swal({
          ...
          .then((willDelete) => {
            ...
            if (willDelete) {
              window.location = "kompindiiot/"+$kompindiid+"/delete";
            } else {
