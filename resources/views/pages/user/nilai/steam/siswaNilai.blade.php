          ...
          <div class="block block-rounded">
            ...
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full" id="tablePengetahuan">
                ...
                <tbody>
                  @foreach ($subindi as $sis)
                    @if ($sis->indikatorsteam_id === 1)
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell text-center" style="width: 15%;" colspan="2">
                              @foreach ($item->subindisteam as $ki)
                                @if ($sis->id === $ki->pivot->subindisteam_id)
                                    @if ($ki->pivot->skor >= 90)
                                        A
                            ...
                            <td>
                                @if ($item->subindisteam()->where('subindisteam_id', '=' , $sis->id)->exists())
                                    <a href="/editNilaiSteam/{{$item->id}}/{{$sis->id}}" class="btn btn-warning">Edit Nilai</a>
                                @else
                                    <a href="/masukanNilaiSteam/{{$item->id}}/{{$sis->id}}" class="btn btn-primary">Tambah Nilai</a>
                                @endif
                            </td>
                        </tr>
                    @endif
                  ...
                  @foreach ($subindi as $si)
                    @if ($si->indikatorsteam_id === 2)
                        <tr>
                            ...
                            <td>
                                @if ($item->subindisteam()->where('subindisteam_id', '=' , $si->id)->exists())
                                    <a href="/editNilaiSteam/{{$item->id}}/{{$si->id}}" class="btn btn-warning">Edit Nilai</a>
                                @else
                                    <a href="/masukanNilaiSteam/{{$item->id}}/{{$si->id}}" class="btn btn-primary">Tambah Nilai</a>
                                @endif
                            </td>
                        </tr>
                    @endif
                    ...
                    @if ($koin->subindisteam_id === 9)
                        <tr>
                            ...
                            <td class="d-none d-sm-table-cell text-center" style="width: 1px;" colspan="">
                                @foreach ($item->subindisteam as $ki)
                                  @if ($koin->subindisteam_id === $ki->pivot->subindisteam_id)
                                      @if ($ki->pivot->skor >= 90)
                                          A
                                      @elseif ($ki->pivot->skor >= 80)
                                          B
                            ...
                            <td>
                                @if ($item->subindisteam()->where('subindisteam_id', '=' , $koin->subindisteam_id)->exists())
                                    <a href="/user/editNilai/{{$item->id}}/{{$koin->subindisteam_id}}" class="btn btn-warning">Edit Nilai</a>
                                @else
                                    <a href="/user/masukanNilai/{{$item->id}}/{{$koin->subindisteam_id}}" class="btn btn-primary">Tambah Nilai</a>
                                @endif
                            </td>
                        </tr>
                    @endif
