            ...
            <div class="block block-rounded">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 space-y-5">
                        ...
                        <form action="/user/masukanNilaiStoreIot/{{$item->id}}/{{$sub->id}}" method="POST">
                            @csrf 
                            <div class="mb-4">
                                ...
                                {{-- <div class="mb-4"> --}}
                                {{-- <label class="form-label" for="mampu">Deskripsi</label>
                                <input type="text" class="form-control" id="mampu" name="mampu"> --}}
                                {{-- <label for="mampu" class="form-label">Deskripsi</label>
                                <textarea class="form-control" id="mampu" rows="3" name="mampu"></textarea> --}}
                            </div>                           
                            {{-- @if ($komp->subindi_id === 8)
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="bsh" name="bsh">
                                </div>
                                <div class="mb-4">
                            ...
                            @else
                                ...
                                <div class="mb-4">
                                <label class="form-label" for="bisa">Nilai</label>
                                <input type="text" class="form-control" id="bisa" name="bisa">
                                </div>
                                <div class="mb-4">
                                <label class="form-label" for="mampu">Deskripsi</label>
                                <input type="text" class="form-control" id="mampu" name="mampu">
